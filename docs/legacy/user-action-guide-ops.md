...
9. 실환경 intake E2E 검증:
   - `npm --workspace apps/web run legacy:e2e:intake -- --api=https://api-production-473bd.up.railway.app`
...
11. benchmark fixture 검수:
   ...
   - 구조/메타데이터 lint: `npm --workspace apps/web run legacy:fixtures:floorplan:validate`
   - blind set gate: `npm --workspace apps/web run legacy:fixtures:floorplan:blind-gate`
