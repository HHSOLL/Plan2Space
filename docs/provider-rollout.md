...
4. fixture 작성
5. `npm --workspace apps/web run fixtures:floorplan:validate`
6. `npm --workspace apps/web run fixtures:floorplan:blind-gate`
7. `npm --workspace apps/web run eval:floorplan`
8. `npm --workspace apps/web run eval:floorplan:gate`
