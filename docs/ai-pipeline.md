...
기본 순서: `snaptrude,anthropic,openai`
...
- `providerErrors`, `providerOrder`
- `candidates[]`: provider별 `score`, `scoreBreakdown`, `metrics`, `errors`, `timingMs`
- `selectedProvider`, `selectedScore`
